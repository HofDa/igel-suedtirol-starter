    ...
    <section className="container-page py-14">
      ...
      <div className="mt-7 overflow-x-auto rounded-2xl border border-emerald-950/10 bg-white">
        <table className="w-full min-w-[650px] text-left">
          <thead className="bg-emerald-950 text-white"><tr><th className="p-4">{t('id')}</th><th className="p-4">{t('municipality')}</th><th className="p-4">{t('type')}</th><th className="p-4">{t('status')}</th></tr></thead>
